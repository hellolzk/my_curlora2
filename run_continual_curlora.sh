...
MODEL_PATH="${MODEL_PATH:-/Users/bytedance/essential_of_lora/model/models/Qwen3-4B}"
DATA_ROOT="${DATA_ROOT:-/Users/bytedance/essential_of_lora/process_data/process_data}"
OUTPUT_ROOT="${OUTPUT_ROOT:-/Users/bytedance/essential_of_lora/my_curlora/continual_runs/qwen3_4b_curlora}"
...
SAMPLING_STRATEGY="${SAMPLING_STRATEGY:-normal}"
U_INIT="${U_INIT:-zero}"
